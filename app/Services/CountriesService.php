...
class CountriesService
{
    public static array $countries = [
        ...
        'CD' => ['alpha2' => 'CD', 'alpha3' => 'COD', 'num' => '180', 'isd' => '243', 'name' => 'Democratic Republic of The Congo', 'continent' => 'Africa'],
        ...
        'TZ' => ['alpha2' => 'TZ', 'alpha3' => 'TZA', 'num' => '834', 'isd' => '255', 'name' => 'Tanzania', 'continent' => 'Africa'],
     ...
     * Non iso countries
     */
    public static array $countries_non_iso = [
        'XK' => ['alpha2' => 'XK', 'alpha3' => 'KOS', 'num' => '383', 'isd' => '383', 'name' => 'Kosovo', 'continent' => 'Europe'],
    ];
     ...
     * @author Paul Bönisch - <paul.boenisch@umwerk.net>
     */
    public static function getCountries($iso = true): array
    {
     ...
     * @author Paul Bönisch - <paul.boenisch@umwerk.net>
     */
    public static function iso($value): CountriesService
    {
        return new CountriesService($value);
    }
     ...
     *
     */
    public static function get($keyField = 'alpha2', $requestedField = 'name'): array
    {
     ...
     *
     */
    public static function get2d($keyField = 'alpha2', $requestedFields = ['alpha2', 'alpha3', 'num', 'isd', 'name', 'continent']): array
    {
        $supportedFields = ['alpha2', 'alpha3', 'num', 'isd', 'name', 'continent'];
        //check if field to be used as array key is passed
        if (! in_array($keyField, $supportedFields)) {
    ...
    *
    */
    public static function getFromContinent($keyField = 'alpha2', $requestedField = 'name', $continent = null): array
    {
        $supportedFields = ['alpha2', 'alpha3', 'num', 'isd', 'name', 'continent'];
